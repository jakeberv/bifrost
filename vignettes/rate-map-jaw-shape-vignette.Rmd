...
converts the landmark array into a two-dimensional species-by-trait
...
On first use, the resolver downloads approximately 3 KB for the tree and 245 KB
for the landmarks from the maintained GitHub copy of the cited
[Dryad dataset](https://datadryad.org/dataset/doi:10.5061/dryad.z08kprrqf).
Later calls reuse the verified cache. This explicit command checks for an
update:
...
knitr::include_graphics(
  normalizePath(
    rate_map_artifact("equal_weight_branch_category_ratemap_default.png"),
    winslash = "/",
    mustWork = TRUE
  ),
  rel_path = FALSE
...
knitr::include_graphics(
  normalizePath(
    rate_map_artifact("equal_weight_branch_category_ratemap.png"),
    winslash = "/",
    mustWork = TRUE
  ),
  rel_path = FALSE
