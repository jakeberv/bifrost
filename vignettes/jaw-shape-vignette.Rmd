...
#We use the provided helper function generateViridisColorScale to assign colors from the perceptually uniform viridis palette to the paramter values representing 'mean' branch-rates

plotSimmap(
  jaws_shape$tree_no_uncertainty_untransformed,
  ftype='off',
  direction='upwards',
  colors = generateViridisColorScale(jaws_shape$model_no_uncertainty$param)$NamedColors
)
generateLegendLabel(jaws_shape, inset_y = 0.1)
