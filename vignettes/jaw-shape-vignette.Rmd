...
plot(
  ...
  point_sizes = c(accepted = 1.05, rejected = 0.75),
  line_widths = c(running_best = 2.10, rejected = 2.40),
  text_sizes = c(
    axis_label = 1.05,
    y_axis = 0.78,
    delta_axis = 0.78,
  ...
  annotation = c(baseline_label_offset = 1.35)
)
