...
This vignette demonstrates the core functionality of the `bifrost` R package. `bifrost` is designed to identify and analyze cladogenic shifts in multivariate trait evolution. It is capable of analyzing datasets including thousands of species [without dimensionality reduction techniques like PCA](https://doi.org/10.1093/sysbio/syv019).
