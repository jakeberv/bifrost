...
```{r jaw_media_cran, echo=FALSE, fig.align="center", out.width="80%", eval = !identical(Sys.getenv("IN_PKGDOWN"), "true")}
...
if (identical(Sys.getenv("IN_PKGDOWN"), "true")) {
  ...
  cat("> **Static frame shown here.** An animated version appears on the package website.  \n",
      ...
      "[MorphoSource](https://www.morphosource.org/concern/media/000670517?locale=en).  \n",
      "> The landmark scheme includes six fixed points (red) and five curves (blue).\n")
}
```
