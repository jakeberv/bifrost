...
The bundled cache reproduces manuscript-era summaries. Its true-negative denominator predates candidate-node-aware accounting, while fresh simulation runs use the current candidate-aware accounting. It is retained for reproducibility rather than silently recomputed.
