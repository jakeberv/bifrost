...
- `progress`: display three persistent search-stage lines with a continuously animated spinner during long fits; counts and ETA advance only when fits complete. Set it to `FALSE` for quiet batch or document builds.
