...
render_preview_table(
  gic_preview_table,
  caption = "Table 1. Empirical-generator GIC tuning grid with 100 repeated 250-tip subsamples per scenario and setting. False positives remain low, and the strongest joint proportional and integration-rate recovery occurs at threshold 10 with a minimum clade size of 10.",
  col_names = c("Threshold", "Min clade", "Null FP", "Prop. F1", "Int.-rate F1"),
  digits = c(0, 0, 3, 3, 3)
)
```
...
render_preview_table(
  bic_preview_table,
  caption = "Table 2. Empirical-generator BIC tuning grid with 100 repeated 250-tip subsamples per scenario and setting. BIC is more conservative than GIC, and the strongest joint recovery occurs at threshold 10 with a minimum clade size of 10.",
  col_names = c("Threshold", "Min clade", "Null FP", "Prop. F1", "Int.-rate F1"),
  digits = c(0, 0, 3, 3, 3)
)
```
...
render_preview_table(
  ...
  caption = "Table 3. Selected settings from the empirical-generator 100-replicate GIC and BIC grids. Both IC families choose threshold 10 and a minimum clade size of 10 because that combination keeps false positives low while maximizing weighted fuzzy recovery across the proportional and integration-rate scenarios.",
  col_names = c("IC", "Threshold", "Min clade", "Null FP", "Prop. F1", "Int.-rate F1"),
