...
[Replicate-level results](https://github.com/jakeberv/bifrost/blob/main/data-remote/simulation-study-cache/passerine_replicate_metrics.rds) are also available for exploring variation and paired comparisons; the [accompanying notes](https://github.com/jakeberv/bifrost/tree/main/data-raw/paired-tuning#replicate-level-results) explain the fields and aggregation.
